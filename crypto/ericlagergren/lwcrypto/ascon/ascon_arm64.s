...
#define ROUND(C) \
	...
	EOR t4, t0, t0 /* t0 ^= t4 */                         \
	                                                      \
	EOR t2@>6-1, t2, s2 /* s2 = t2 ^ rotr(t2, 6-1) */     \
	EOR t3@>17-10, t3, s3 /* s3 = t3 ^ rotr(t3, 17-10) */ \
	EOR t4@>41-7, t4, s4 /* s4 = t4 ^ rotr(t4, 41-8) */   \
	EOR t0@>28-19, t0, s0 /* s0 = t0 ^ rotr(t0, 28-19) */ \
	EOR t1@>61-39, t1, s1 /* s1 = t1 ^ rotr(t1, 61-39) */ \
	                                                      \
	EOR s3@>10, t3, s3 /* s3 = t3 ^ rotr(s3, 10) */       \
	EOR s4@>7, t4, s4 /* s4 = t4 ^ rotr(s4, 7) */         \
	EOR s0@>19, t0, s0 /* s0 = t0 ^ rotr(s0, 19) */       \
	EOR s1@>39, t1, s1 /* s1 = t1 ^ rotr(s1, 39) */       \
	EON s2@>1, t2, s2 /* s2 = t2 ^ rotr(s2, 1) */         \
	                                                      \
